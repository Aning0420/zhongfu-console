...
- 喂食计划中，meal.food 必须填写这一餐所有实际消耗的食物、奶粉和营养补充剂及用量，例如“澳龙处方粮10g＋麦德氏K41羊奶粉5g＋乳铁蛋白0.225g＋K09益生菌1g”；温水、冲泡方式、磨粉方式等不消耗库存的内容放在 meal.note。stage.supplements 仍填写营养补充汇总（如有使用时间请注明），但不能替代 meal.food 中的消耗项目
